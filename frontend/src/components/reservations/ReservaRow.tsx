...
export default function ReservaRow({ reserva }: { reserva: Reserva }) {
  return (
    <div className="grid grid-cols-[1fr_1fr_1.5fr_1.5fr_130px_100px] items-center gap-4 rounded-2xl border border-white/[0.06] bg-[#0d0d0d] px-5 py-4 transition hover:border-[#267F6B]/25 hover:bg-[#0d0d0d]"> {/* TODO: migrate to COLORS.surface, COLORS.accent */}
      {/* Cliente */}
